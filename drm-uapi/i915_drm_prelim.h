...
#define __PRELIM_I915_PMU_RENDER_GROUP_BUSY_TICKS(gt)	___PRELIM_I915_PMU_OTHER(gt, 11)
#define __PRELIM_I915_PMU_COPY_GROUP_BUSY_TICKS(gt)	___PRELIM_I915_PMU_OTHER(gt, 12)
#define __PRELIM_I915_PMU_MEDIA_GROUP_BUSY_TICKS(gt)	___PRELIM_I915_PMU_OTHER(gt, 13)
#define __PRELIM_I915_PMU_ANY_ENGINE_GROUP_BUSY_TICKS(gt)	___PRELIM_I915_PMU_OTHER(gt, 14)
#define __PRELIM_I915_PMU_TOTAL_ACTIVE_TICKS(gt)	___PRELIM_I915_PMU_OTHER(gt, 15)
